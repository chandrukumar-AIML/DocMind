    ...
    async def run_tests():
        ...
        try:
            ...
            try:
                ...
                print("   ✅ LoginRequest: rejected weak password (<8 chars)")

            # UserCreate with password strength validation
            reg_req = UserCreate(
                email="new@docmind.ai",
                password="SecurePass123!",
            ...
            try:
                ...
                if "uppercase" in str(e).lower():
                    print("   ✅ UserCreate: rejected password without uppercase")
            ...
            try:
                ...
                if "current password" in str(e).lower():
                    print("   ✅ UserUpdate: requires current_password for sensitive changes")
            ...
            print("   ✅ _validate_auth_inputs: valid inputs accepted")
            ...
            print("   ✅ TokenResponse: serializes to dict")
            ...
            print("   ✅ RegistrationPendingResponse: created")
            ...
            print("   ✅ Response models: TokenResponse, RegistrationPendingResponse, ProfileResponse")
            ...
            print("   ✅ get_auth_metadata: returns config for debugging")
            ...
            print("   ✅ Module exports: router, get_auth_metadata in __all__")
