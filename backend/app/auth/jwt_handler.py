    ...
    async def run_tests():
        ...
        try:
            from app.auth.jwt_handler import (
                ...
                _TOKEN_TYPE_ACCESS, _TOKEN_TYPE_REFRESH
            )
            ...
            try:
                ...
                if "exceeds maximum length" in str(e):
                    print(f"   ✅ Long password rejected (bcrypt 72-byte limit)")
            ...
            print(f"   ✅ verify_access_token: returned valid payload")
            ...
            try:
                ...
                if "expired" in str(e).lower() or "Signature has expired" in str(e):
                    print(f"   ✅ Expired token rejected: JWTError")
            ...
            print(f"   ✅ verify_access_token: returned None for expired token")
            ...
            print(f"   ✅ Refresh token decoded: type={refresh_payload['type']}, family_id={refresh_payload['family_id']}")
            ...
            try:
                ...
                if "type mismatch" in str(e).lower() or "Token type mismatch" in str(e):
                    print(f"   ✅ Type mismatch rejected: access vs refresh")
            ...
            print(f"   ✅ decode_token: decodes signature-valid tokens (app validates claims)")
            ...
            try:
                ...
                print(f"   ✅ Wrong secret key rejected: JWTError")
            ...
            try:
                ...
                print(f"   ✅ Invalid format rejected: JWTError")
            ...
            try:
                ...
                print(f"   ✅ Type mismatch rejected: JWTError")
