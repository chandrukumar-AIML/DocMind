...
__all__ = [
    ...
    "get_current_user", "require_editor", "require_admin", "AuthenticatedUser",
    # Validators (centralized)
    "validate_email", "validate_slug", "validate_workspace_id", "validate_password_strength",
]
...
def __getattr__(name: str):
    ...
    # FastAPI Dependencies
    if name in ("get_current_user", "require_editor", "require_admin", "AuthenticatedUser"):
    ...
    if name in ("validate_email", "validate_slug", "validate_workspace_id", "validate_password_strength"):
