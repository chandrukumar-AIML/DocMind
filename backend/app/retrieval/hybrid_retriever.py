...
class HybridRetriever:
    ...
    def __init__(
        ...
        logger.info(
            f"HybridRetriever initialized: workspace={workspace_id}, "
    ...
    async def search_async(
        ...
        try:
            ...
            for chunk_id, data in results_map.items():
                ...
                hybrid_results.append(HybridRetrievalResult(
                    chunk_id=chunk_id,
                    score=score,
    ...
    def search(
        ...
        try:
            ...
            logger.warning(
                f"⚠️ HybridRetriever.search() called from async context — "
            ...
            return asyncio.run(
                self.search_async(query, query_embedding, k, filter_dict, correlation_id)
            )
