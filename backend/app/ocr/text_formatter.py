...
class EnrichedTextFormatter:
    ...
    @staticmethod
    def _validate_inputs(block: "TextBlock | None", enriched: "EnrichedDocument | None", corr_id: str) -> tuple[bool, str]:
    ...
    def get_format_stats(
        ...
        return {
            ...
            "scrub_reduction_pct": round((1 - scrubbed_chars / total_chars) * 100, 2) if total_chars > 0 and scrub_pii else 0.0,
    ...
    def run_tests():
        ...
        try:
            from app.ocr.text_formatter import (
                EnrichedTextFormatter, _MAX_FORMAT_LENGTH, _MAX_BULLET_POINTS
            )
            ...
            print(f"   ✅ Methods: format_block, format_document present")
            ...
            print(f"   ✅ Truncation: Long text truncated when scrub=False")
            ...
            print(f"   ✅ Scrubbing: PII removed/replaced")
            ...
            print(f"   ✅ Text Block: Returns raw text")
            ...
            print(f"   ✅ Table Block: Fallback to raw text when no analysis")
            ...
            print(f"   ✅ Table Block: Returns summary + markdown")
            ...
            print(f"   ✅ Diagram Block: Returns formatted description + bullets")
            ...
            result = EnrichedTextFormatter.format_document(enriched, scrub_pii=False, include_metadata=True, correlation_id="t7")
            assert "Document: Test Doc" in result
            assert "Block 1" in result
            assert "Block 2" in result
            print(f"   ✅ Document: Metadata + Blocks formatted together")
            ...
            async def test_async():
                ...
                result = await EnrichedTextFormatter.format_block_async(
                    block, enriched, scrub_pii=False, correlation_id="t8", timeout_seconds=2.0
                )
            ...
            assert success
            print(f"   ✅ Async: Wrapper works correctly")
            ...
            print(f"   ✅ Stats: Correct block and char counts")
