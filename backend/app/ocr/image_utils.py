    ...
    try:
        result = await asyncio.wait_for(
            loop.run_in_executor(
                None,
                lambda: image_to_b64(image, quality, max_dimension, corr_id)
            ),
    ...
    def run_tests():
        ...
        try:
            ...
            from app.ocr.image_utils import (
                image_to_b64, image_to_b64_async,
                calculate_image_tokens, b64_to_image,
                _validate_image_for_b64, _guard_image_size,
                _DEFAULT_JPEG_QUALITY, _DEFAULT_MAX_DIMENSION, _MAX_IMAGE_PIXELS
            )
            ...
            print(f"   ✅ Constants: quality={_DEFAULT_JPEG_QUALITY}, max_dim={_DEFAULT_MAX_DIMENSION}, max_pixels={_MAX_IMAGE_PIXELS}")
            ...
            print(f"   ✅ Grayscale 2D: preserved")
            ...
            assert result.dtype == np.uint8
            print(f"   ✅ Float array: converted to uint8")
            ...
            try:
                ...
                print(f"   ✅ Non-numpy input: rejected")
            ...
            try:
                ...
                print(f"   ✅ Unsupported channels: rejected")
            ...
            print(f"   ✅ Large image: downscaled to max_dimension")
            ...
            print(f"   ✅ Huge image: downscaled by pixel count limit")
            ...
            print(f"   ✅ Quality control: low quality -> smaller output")
            ...
            print(f"   ✅ Invalid input: fallback to minimal valid base64")
            ...
            print(f"   ✅ Async wrapper: returns valid base64")
            ...
            assert result is True
            print(f"   ✅ Async timeout: returns fallback base64")
            ...
            print(f"   ✅ Round-trip: shape and dtype preserved")
            ...
            print(f"   ✅ data: URI prefix: stripped correctly")
            ...
            print(f"   ✅ Invalid base64: returns fallback image")
