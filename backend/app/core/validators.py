...
_PASSWORD_COMPLEXITY_REGEX: Final = re.compile(
    ...
    def run_tests():
        ...
        try:
            from app.core.validators import (
                validate_email, validate_slug, validate_workspace_id,
                validate_password_strength, sanitize_for_display,
                validate_tags, normalize_tags, EMAIL_REGEX, SLUG_REGEX
            )
            ...
            try:
                ...
                print(f"   [OK] Invalid format rejected")
            ...
            try:
                ...
                print(f"   [OK] Invalid pattern rejected")
            ...
            try:
                ...
                print(f"   [OK] Short length rejected")
            ...
            print(f"   [OK] Literal 'default' accepted")
            ...
            print(f"   [OK] Plain text preserved")
            ...
            print(f"   [OK] validate_tags: normalized and case-lowered")
            
            # Normalize (dedup while preserving order)
            tags = normalize_tags(["a", "b", "a", "c"])
            assert tags == ["a", "b", "c"]
            print(f"   [OK] normalize_tags: deduplication preserved order")
            ...
            try:
                ...
                print(f"   [OK] Tags with special chars rejected")
