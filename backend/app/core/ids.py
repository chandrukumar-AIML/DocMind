...
if __name__ == "__main__":
    ...
    def run_tests():
        ...
        try:
            ...
            print("   [OK] Unique: different inputs -> different ID")
            ...
            print("   [OK] Chunk ID: different page -> different ID")
            ...
            print("   [OK] Query ID: unique with random suffix")
            ...
            print("   [OK] Query ID: different workspace -> different deterministic part")
            ...
            print("   [OK] Correlation ID: prefix sanitized 'My-API@2026!' -> 'my_api_2026_'")
