...
if __name__ == "__main__":
    ...
    async def run_tests():
        ...
        try:
            ...
            print("   [OK] Threshold reached: state -> OPEN")
            ...
            print("   [OK] Recovery timeout: state -> HALF_OPEN")
            ...
            assert cb._state == "CLOSED"
            print("   [OK] Success in HALF_OPEN: state -> CLOSED")
            ...
            print("   [OK] Context manager: success recorded")
            ...
            print("   [OK] Context manager: failures tracked, breaker opened")
            ...
            print("   [OK] Presets available: redis_retry, http_retry")
            ...
            print("   [OK] Jitter config: enabled/disabled flags work")
            ...
            print("   [OK] Default config: max_attempts=3, backoff=0.1-5.0s, jitter=True")
