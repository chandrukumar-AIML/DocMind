...
class EvalRunResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "results_summary": {k: v for k, v in self.results.items() if k in ["accuracy", "mean_score", "n_examples"]}
            if self.results
            else {},
        }
    ...
    def add_examples(
        ...
        for i in range(0, len(inputs), batch_size):
            ...
            try:
                ...
                logger.error(f"[{corr_id}] Batch {i // batch_size + 1} (examples {failed_indices}) upload failed: {e}")
