import pytest
import asyncio
from app.evaluation.retrieval_metrics import RetrievalEvaluator, RetrievalResult
from app.evaluation.ocr_metrics import OCRMetricsCalculator
from app.evaluation.text_utils import tokenize_for_wer, normalize_text_for_ocr
